...
> says **what to check and where**; it does **not** freeze limits or approval
> statuses. Pull the current status live before any verdict.
>
...
>   inhaled fumes from, splashed in the eye, been burned by, or mixed** these
>   products and produced gas — that's a **poison-control / emergency** situation,
>   not a product choice. Point there first.
>
...
> - **EU — the anchor.** Detergents & surfactants: the **new Detergents &
>   Surfactants Regulation (EU) 2026/405** (published March 2026, **repealing the
>   old (EC) 648/2004** with a multi-year transition into ~2029–30) — covers
>   **surfactant biodegradability, phosphate / phosphorus limits in consumer laundry
>   and consumer automatic-dishwasher detergents, fragrance-allergen labelling**, a
>   Digital Product Passport, and spray-format warnings. Hazard classification &
>   labelling: **CLP Regulation (EC) 1272/2008** (as amended by (EU) 2024/2865) —
>   corrosive / irritant pictograms + the UFI / poison-centre notification.
>   **Disinfectants:** the **Biocidal Products Regulation (EU) 528/2012** — the
>   active + product need authorisation and proven efficacy.
...
>     chemical registration. **BIS standards exist** (e.g. **IS 4955** for household
>     laundry detergent powder) but **the ISI mark is voluntary** here — check
>     whether the exact product is under any compulsory Quality Control Order rather
>     than assuming a mark is required.
>   - **Disinfectants / germ-kill products have no unified "biocide" regime.** A
>     product can fall under the **Drugs & Cosmetics Act** (disinfectant standards in
>     **Schedule O**; **Schedule K** can exempt disinfectants from the drug
>     stock/sale licence; **CDSCO** oversight) **and/or** **CIB&RC under the
>     Insecticides Act 1968** (which a pending Pesticide Management Bill may replace).
>     Biocide guidelines are still under discussion — so **classification is
>     genuinely unsettled; check the specific product's claim and how it's actually
>     registered**, don't assert one clean rule.
>   - Hazardous-chemical handling sits under the **Manufacture, Storage & Import of
>     Hazardous Chemicals Rules** + BIS labelling.
...
>
> ## Evidence hierarchy
> Label + **Safety Data Sheet (SDS)** → the applicable standard (EU 2026/405 / CLP /
> BPR, or the Indian regime for the claim) → a **recognised efficacy test** (for
> disinfectants) or **biodegradability data** (for green claims) → independent test →
> reviews **only** for usability (smell, cutting power, residue). **Treat an
> undisclosed formula / missing SDS as an evidence gap, not a pass.**
>
...
- **Check live** — biodegradability + phosphate limits for **consumer laundry**
  detergents under **EU Reg 2026/405** (the stricter reference); fragrance-allergen
  declaration; whether the product is a plain detergent or makes an **"antibacterial"
  claim** (→ §5 disinfectant regime). India: general consumer good; **IS 4955** is a
  reference but its mark is voluntary.
...
- **Evidence** — EU 2026/405, ecolabel criteria, dermatology on detergent allergens.
...
- **What matters** — cleaning + rinse-off (food-contact-adjacent: it's on your
  plates), skin irritation (hand dishwash), phosphates (machine detergents),
  fragrance.
- **Check live** — phosphate / phosphorus limits for **consumer automatic-dishwasher
  detergents** under **EU 2026/405**; surfactant biodegradability; skin-irritant
  labelling (CLP). Rinse-aid residue and correct dosing.
- **EU-vs-India gap** — EU tighter on phosphates + labelling; prefer low-phosphate,
  well-rinsing, allergen-declared products.
...
- **Evidence** — EU 2026/405, CLP, ecolabel criteria.

## 3. All-purpose / floor / surface cleaners (incl. phenyl)
- **What matters** — cleaning performance, **irritant / corrosive rating**,
  fragrance load, and the **cleaner-vs-disinfectant** distinction.
...
- **Check live** — the acid used (often **hydrochloric acid**) and its CLP corrosive
  ...
  natural stone / some metals). **State the NEVER-MIX rule** — an acidic toilet
  cleaner **must not** be combined with bleach (→ chlorine gas).
- **EU-vs-India gap** — EU corrosive-hazard labelling is explicit; the safety points
  hold regardless of jurisdiction.
- **Red flags** — no corrosive warning / child-resistant cap; instructions that
  invite mixing with other products; decanted into an unlabeled bottle; used on
  stone/metal it will etch.
...
- **Check live**
  - **Efficacy needs a recognised test + named pathogens + a contact time.** Look
    for a cited standard — EU **EN 1276** (bactericidal), **EN 14476** (virucidal),
    **EN 1650** (fungicidal), **EN 13697** (surfaces) or equivalent — **"kills
    99.9%" alone, with no test, no organism and no contact time, is not proof.**
    Disinfection also requires the surface be **cleaned first** and the product left
    **wet for the full contact time**.
  - **Regulation — EU:** authorised under the **Biocidal Products Regulation (EU)
    528/2012**. **US:** an **EPA registration number** (antimicrobial pesticide).
    **India:** unsettled — may sit under the **Drugs & Cosmetics Act (Schedule O/K,
    CDSCO)** and/or **CIB&RC / Insecticides Act**; **check how the specific product
    is actually registered** rather than assuming.
- **EU-vs-India gap** — the EU/US demand documented efficacy + registration; India's
  framework is fragmented → weight products with **verifiable test reports** and
  clear registration, and be wary of "ayurvedic / herbal disinfectant" germ claims
  without data.
...
- **Cross-check** — a citable EN / EPA-registration / lab efficacy report; correct
  Indian registration for the claim.
- **Review lens** — usability only; **never** infer efficacy from reviews.
- **Evidence** — EU BPR + EN standards, US EPA, published efficacy tests.
...
- **Check live** — CLP corrosive/irritant classification; **NEVER mix** — with acid
  → **chlorine gas**, with ammonia → **chloramine vapour**; proper **dilution and
  contact time** for any disinfection use (concentration + freshness matter, bleach
  degrades); ventilation.
- **EU-vs-India gap** — hazard labelling is clearer in the EU; the chemistry/safety
  is universal.
- **Red flags** — advice to mix "for strength"; using neat bleach on skin/food;
  storing next to acids; no ventilation; expecting old/weak bleach to disinfect.
...
- **Check live** — active (often **sodium hydroxide / lye**, sometimes strong acid)
  and its CLP corrosive classification; **mandatory gloves + eye protection +
  ventilation**; child-resistant packaging; **never mix** products or use in a
  closed drain with standing chemical; surface compatibility.
...
- **Red flags** — no corrosive warning / child-resistant cap; encouragement to mix
  or to pour onto an existing chemical; no PPE guidance; decanted/unlabeled.
- **Cross-check** — corrosive hazard label + SDS, child-resistant packaging.
...
- **Check live** — VOC / fragrance-allergen content; **aerosol flammability +
  propellant** labelling (CLP); any **"kills airborne germs / purifies air"** claim
  (usually weak — treat as a disinfectant claim needing evidence per §5). It is **not
  a substitute for cleaning or ventilation.**
- **EU-vs-India gap** — EU allergen / hazard labelling is explicit; Indian labels
  vary → prefer allergen-declared, low-VOC products.
- **Red flags** — "air-purifying / germ-killing" spray with no evidence; heavy
  fragrance around asthmatics, infants or pets; aerosol used near flame; masking a
  smell instead of removing the source.
...
2026/405, CLP, BPR 528/2012) / CDSCO / CIB&RC / BIS — fetch them in Deep mode; don't
rely on figures hard-coded in any file, including this one.*
